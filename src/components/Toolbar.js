...
import { Dimensions, Image, Modal, Text, Switch, View, TouchableWithoutFeedback } from 'react-native';
  ...
  render() {
    ...
    return (
      <View style={{
        ...
        <View style={{ flex: 0, flexDirection: 'row', paddingLeft: 20, paddingRight: 20 }}>
          <Text style={{fontSize: 20, backgroundColor: 'rgba(0,0,0,0)', color: 'rgb(68, 68, 68)'}}>stats  </Text>
          <Switch value={this.props.stats} onValueChange={this.props.toggleStats} />
        </View>
      </View>
    );
  }
